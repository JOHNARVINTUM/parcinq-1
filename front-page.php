 ...
 * Front page template.
 *
 * Dynamic homepage content for Parcinq.
 *
		...
		<?php if ( $parcinq_hero_post ) : ?>
			<a class="hero-media" href="<?php echo esc_url( get_permalink( $parcinq_hero_post ) ); ?>">
				...
				<div class="wrap hero-content reveal">
					...
					<p><?php echo esc_html( get_the_excerpt( $parcinq_hero_post ) ); ?></p>
					<div class="byline"><?php echo esc_html( get_the_date( '', $parcinq_hero_post ) ); ?><?php if ( ! empty( $parcinq_hero_credits ) ) : ?> <?php echo esc_html( '·' ); ?> <?php echo esc_html( implode( ' · ', $parcinq_hero_credits ) ); ?><?php endif; ?></div>
		...
		<div class="fr-inner">
			...
			<div class="fr-text reveal">
				...
				<?php if ( ! empty( $parcinq_cityboy_posts ) ) : ?>
					...
					<p><?php echo esc_html( get_the_excerpt( $parcinq_cityboy_posts[0] ) ); ?></p>
		...
		<div class="wrap">
			...
			<div class="style-grid reveal">
				<?php foreach ( $parcinq_style_posts as $parcinq_post ) : ?>
					<?php $parcinq_card_category = $parcinq_get_post_category( $parcinq_post->ID ); ?>
					<a class="style-card" href="<?php echo esc_url( get_permalink( $parcinq_post ) ); ?>"><?php $parcinq_render_post_media( $parcinq_post->ID, 'large', __( 'Style', 'parcinq-theme' ) ); ?><div class="scrim"></div><div class="meta"><span class="tag"><?php echo esc_html( $parcinq_card_category ? $parcinq_card_category->name : __( 'Style', 'parcinq-theme' ) ); ?></span><h3><?php echo esc_html( get_the_title( $parcinq_post ) ); ?></h3><p><?php echo esc_html( get_the_excerpt( $parcinq_post ) ); ?></p></div></a>
				<?php endforeach; ?>
			</div>
		</div>
	</section>
